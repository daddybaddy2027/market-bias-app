...
export const MODEL_CATALOG: ModelDefinition[] = [
  ...
  },
  {
    ...
    performance: {
      ...
      n: 6,
      hits: 6,
      averageSignedPips: 33.4,
      period: "13–15 Jul 2026",
      note: "Small verified sample. Average signed result is per active signal.",
    },
    independent: {
      accuracy: 1,
      n: 2,
  ...
  },
  {
    ...
    performance: {
      ...
      accuracy: 1,
      n: 5,
      note: "Very small evaluation sample. Live verification remains decisive.",
    },
  },
  {
    order: 8,
